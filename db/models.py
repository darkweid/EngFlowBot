...
class UserWordsLearning(Base):
    ...
    new_word: Mapped["NewWords"] = relationship(back_populates="user_words")
...
Index(
    "ix_user_section",
    UserWordsLearning.user_id,
    UserWordsLearning.section,
...
class UserProgress(Base):
    ...
    exercise_section: Mapped[str] = mapped_column(
        String(64), primary_key=True, nullable=False
    )
    exercise_subsection: Mapped[str] = mapped_column(
        String(64), primary_key=True, nullable=False
    )
    exercise_id: Mapped[int] = mapped_column(Integer, primary_key=True, nullable=False)
...
class User(Base):
    ...
    tg_login: Mapped[str | None] = mapped_column(String(32))
...
class DailyStatistics(Base):
    ...
    total_testing_exercises: Mapped[int] = mapped_column(
        Integer, default=0, nullable=False
    )
    total_new_words: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    total_irregular_verbs: Mapped[int] = mapped_column(
        Integer, default=0, nullable=False
    )
